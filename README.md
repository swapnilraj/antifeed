...
>
> 1. Read the full playbook first: <https://raw.githubusercontent.com/swapnilraj/social-wall/main/docs/setup.md>
> 2. Create the instance: `npx -y github:swapnilraj/social-wall init antifeed && cd antifeed && npm install`
